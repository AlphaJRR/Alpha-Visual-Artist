    ...
    <section id="join-crew" className="py-32 bg-black relative border-t border-white/5 overflow-hidden">
      ...
      <div className="marketing-wrap relative z-10">
        ...
        >
          ...
          <p className="section-lead text-xl md:text-2xl text-white/60 mb-12">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
              asChild
              size="lg"
              className="btn-marketing bg-primary hover:bg-primary/90 text-black px-12 text-xl font-bold shadow-[0_0_30px_rgba(0,230,255,0.3)] transition-all hover:shadow-[0_0_50px_rgba(0,230,255,0.5)] hover:scale-105 group"
            >
              <a href="/apparel">
                Shop The Collection
            ...
            <Button
              ...
              size="lg"
              variant="outline"
              className="btn-marketing btn-marketing--outline border-white/20 hover:bg-white/5 text-lg font-semibold transition-all hover:border-primary/50"
            >
